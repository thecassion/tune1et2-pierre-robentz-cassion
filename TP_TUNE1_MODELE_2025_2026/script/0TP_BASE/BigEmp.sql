...
drop table bigdept cascade constraint;
drop table bigemp cascade constraint;

DROP TYPE TabNoms_T;
CREATE OR REPLACE TYPE TabNoms_T 
...
alter table bigdept add constraint pk_bigdept
primary key (deptno);

alter table bigemp add constraint pk_bigemp
primary key (empno);


alter table bigemp add constraint fk_bigemp_deptno
...
-- Insertion de lignes dans la table des départements
INSERT INTO BIGDEPT VALUES
        (10,'ACCOUNTING','NEW YORK');
INSERT INTO BIGDEPT VALUES (20,'RESEARCH','DALLAS');
INSERT INTO BIGDEPT VALUES
        (30,'SALES','CHICAGO');
INSERT INTO BIGDEPT VALUES
...
-- insertion de lignes dans la table des employés
INSERT INTO BIGEMP VALUES
...
-- insertion de nouvelles lignes dans la tables des employés.
DECLARE
	lesNoms	tabNoms_t:= tabNoms_t('Dupont', 'Durand', 'Foudil', 'Foudelle', 'Akim', 'Bleck', 'Zembla', 'Tintin', 'Milou', 'Mopolo', 'Malik', 'Amidou', 'Mamadou', 'Mariama', 'Marine', 'Mouloud', 'Chang', 'Li', 'Bruce', 'Balak');
	j		number:=1;
BEGIN
	For i In 1 .. 10000
	loop
