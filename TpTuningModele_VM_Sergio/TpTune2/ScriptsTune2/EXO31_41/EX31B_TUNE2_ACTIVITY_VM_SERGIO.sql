...
-- Cinq applications qui font la même chose seront installées :
	...
	-- La 3ème écrite en relationnel (EMP4, DEPT4) les tables sont organisees dans des segments séparés
	-- La 4ème écrite en relationnel mais les tables sont organisées dans un cluster indexé (IEMP4, IDEPT4)
	-- La 5ème écrite en relationnel mais les tables sont organisées dans un cluster haché (HEMP4, HDEPT4)
...
begin
	...
	insert into BIGOEMP e 
	values(5, 'FOUDELLE', tabPrenoms_t('Amina', 'traoré'),'Planton', 
	...
	insert into BIGOEMP e 
	values(10, 'RACKHAM', tabPrenoms_t('Le rouge'),'Secrétaire', 
	...
	insert into BIGOEMP e 
	values(seq_empno.nextval, 'FOUDELLE', tabPrenoms_t('Amina'||i, 'traoré'),'Planton', 
	...
	insert into BIGOEMP e 
	values(seq_empno.nextval, 'RACKHAM', tabPrenoms_t('Le rouge'||i),'Secrétaire', 
...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
-- Deuxième application écrite en objet relationnel (table objet: BIGOEMP2, BIGODEPT2) -----------------------
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
...
-- Laisser la création de cet index en commentaire. On vera l'effet de son absence avec les conseillers tuning
-- et les requêtes qui l'impliquent.
...
begin
	...
	insert into BIGOEMP2 e 
	values(seq_empno2.nextval, 'FOUDELLE', tabPrenoms_t('Amina'||i, 'traoré'),'Planton', 
	13600, empty_clob(),to_date('10-10-1978', 'DD-MM-YYYY')+4,
	to_date('10-10-2002', 'DD-MM-YYYY')+4,refDept3) ;
	...
	insert into BIGOEMP2 e 
	values(seq_empno2.nextval, 'RACKHAM', tabPrenoms_t('Le rouge'||i),'Secrétaire', 
	13400, empty_clob(),to_date('10-10-1978', 'DD-MM-YYYY')+30,
	to_date('10-10-2002', 'DD-MM-YYYY')+30,refDept1) ;
...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
-- Troisième application écrite en relationnel (table relationnelles: R_EMPLOYE, R_DEPT) ---------------------
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------
-- 4ème application écrite en relationnelle (EMP4, DEPT4) les tables sont organisees dans des segments séparés -----
-- 4ème application écrite en relationnelle mais les tables sont organisées dans un cluster indexé (IEMP4, IDEPT4)--
-- 5ème application écrite en relationnelle mais les tables sont organisées dans un cluster haché (HEMP4, HDEPT4)---
...
- des tables EMP4 et DEPT4 segment séparé.
- des tables IEMP4 et IDEPT4 en cluster indexé.
- des tables HEMP4 et HDEPT4 en cluster haché.
- Ces tables contiennent un même nombre de lignes
...
-- Création des table IEMP4 et IDEPT4 dans  un cluster indexé
...
-- Création des table HEMP4 et HDEPT4 dans  un cluster haché
